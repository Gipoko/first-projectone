<header id="page-topbar">
                <div class="navbar-header">
                    ...
                    @csrf
                    <button type="submit" class="dropdown-item text-danger" href="#" onclick="event.preventDefault();"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout">Logout</span></button>
